...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\handler_pkg\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/handler_pkg/local_setup.bat"
